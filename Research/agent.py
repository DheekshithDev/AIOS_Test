...
class AutoGenAgent:
    ...
    def run(self, task):
        ...
        final_result = user_proxy.initiate_chat(manager, message=task, summary_method="reflection_with_llm", max_turns=2).summary
        #example: Find a latest paper about gpt-4 on arxiv and find its potential applications in software.
        return {
