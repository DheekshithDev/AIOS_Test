    ...
    def check_workflow(self, message):
        try:
            ...
            for step in workflow:
                if "action_type" not in step or "action" not in step or "tool_use" not in step:
                    return None
    ...
    def build_system_instruction(self):
        ...
        plan_instruction = "".join(
            [
                ...
                '['
                '[',
                '{"action_type": "call_tool", "action": "gather information from arxiv. ", "tool_use": ["arxiv"]},',
                '{"action_type": "message_llm", "action": "write a summarization based on the gathered information. ", "tool_use": []}',
                '];',
                '[',
                '{"action_type": "call_tool", "action": "gather information from arxiv. ", "tool_use": ["arxiv"]},',
                '{"action_type": "call_tool", "action": "understand the current methods and propose ideas that can improve ", "tool_use": []}',
                ']',
                ']'
            ]
        )
        ...
        workflow = [
            {
                ...
                "action": "Determine the story genre and theme based on user input and generate initial story plot and the main character.",
                "tool_use": []
            },
            # {
            #     "action_type": "message_llm", 
            ...
            {
                "action_type": "message_llm", 
                "action": "Create a visual representation for the main character and incorporate it into the story narrative.",
                "tool_use": []
            }
        ]
        return workflow
